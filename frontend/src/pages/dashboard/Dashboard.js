...
const Dashboard = () => {
  ...
  /// function to upload poem

  const poemFrom = async (e) => {
    e.preventDefault();
    const { email, poem } = poemData;
  ...
  return (
    <div>
      <nav className="navbar navbar-expand-lg navbar-light " style={{ "background": "#f0f0f0" }}>
                ...
                <div className="row">
                  <div className="col-md-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex justify-content-center flex-column">
                    <h1 className='text-center'>
                      ...
                      <strong className="brand-name text-center">  <h1 style={{ "textAlign": "center", "padding": "10px", "color": "#eb7efd" }}>
                        welcome {userData.name} !
                      </h1></strong>
                    </h1>
                    {/* <h2 className="my-3 text-center"> */}
                    <div className='container' style={{ "textAlign": "justify", "fontSize": "12px" }}> Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat nonc.</div>
                    {/* </h2> */}

                  </div>
                  <div className="col-lg-6 order-1 order-lg-2 header-img">
                    {/* <img src={Q1} className="img-fluid animated" alt="" /> */}
      ...
      <form method='POST'>
        <div className='container' style={{ "padding": "20px" }}>
          <div class="input-group">
            <span class="input-group-text"> begin here </span>
            <textarea class="form-control" aria-label="With textarea" name='poem' value={poemData.poem} onChange={handleInputs2} ></textarea>
            {/* <input className="form-control me-2" type="text" name='poem' placeholder="write article" aria-label="search" value={poemData.poem} onChange={handleInputs2} /> */}
          </div>
          <div class="d-grid gap-2" style={{ "padding": "20px" }}>
            <button class="btn btn-primary" type="submit" style={{ "background": "#8A2BE2", "color": "white" }} onClick={poemFrom}>Submit</button>
          </div>
        </div>
      </form>
